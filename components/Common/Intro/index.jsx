...
import { FaDownload, FaFacebook, FaGithub, FaLinkedin, FaTwitter, FaBlog } from 'react-icons/fa';
...
import Osama from '../../../public/images/kevin.jpg';
  ...
  return (
    <>
      ...
      <div className='footer absolute flex justify-center space-x-6 text-xl items-center bottom-0 z-50 h-10 w-full bg-MidNightBlack text-Snow'>
        <Link href={"https://github.com/doshi-kevin"} target='_blank' rel='noreferrer' className=''>
          <FaGithub />
        </Link>
        ...
        <Link href={"https://www.linkedin.com/in/visittokevin/"} target='_blank' rel='noreferrer' className=''>
          <FaLinkedin />
        </Link>
        <Link href={"https://medium.com/@convey2kevin1012"} target='_blank' rel='noreferrer' className=''>
          <FaBlog />
        </Link>
      </div>
    </>
